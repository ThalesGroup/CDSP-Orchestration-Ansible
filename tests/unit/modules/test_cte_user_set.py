...
from ansible_collections.thalesgroup.ciphertrust.plugins.modules.cte_user_set import main


class TestCteUserSet:
    @patch("ansible_collections.thalesgroup.ciphertrust.plugins.modules.cte_user_set.ThalesCipherTrustModule")
    @patch("ansible_collections.thalesgroup.ciphertrust.plugins.modules.cte_user_set.idempotent_create")
    ...
    @patch("ansible_collections.thalesgroup.ciphertrust.plugins.modules.cte_user_set.ThalesCipherTrustModule")
    @patch("ansible_collections.thalesgroup.ciphertrust.plugins.modules.cte_user_set.idempotent_patch")
