...
from ansible_collections.thalesgroup.ciphertrust.plugins.modules.cm_regtoken import main

class TestCmRegtoken:
    @patch("ansible_collections.thalesgroup.ciphertrust.plugins.modules.cm_regtoken.ThalesCipherTrustModule")
