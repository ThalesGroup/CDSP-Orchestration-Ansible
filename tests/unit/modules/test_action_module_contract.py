...
CCKM_AWS_ACTIONS = [
    ...
    # ---- CCKM OCI -----------------------------------------------------
    Action("cckm_oci_tenancy",
           {'op_type': 'add', 'tenancy': 't'},
           "post", "cckm/oci/add-tenancy"),
    Action("cckm_oci_tenancy",
           {'op_type': 'delete', 'tenancy_id': 'res-1'},
           "delete", "cckm/oci/tenancy/res-1"),
    Action("cckm_oci_compartment",
           {'op_type': 'add', 'connection': 'c', 'compartment_ids': ['x']},
           "post", "cckm/oci/add-compartments"),
    Action("cckm_oci_compartment",
           {'op_type': 'delete', 'compartment_id': 'res-1'},
           "delete", "cckm/oci/compartments/res-1"),
    Action("cckm_oci_vault",
           {'op_type': 'add', 'connection': 'c', 'region': 'r', 'vault_ids': ['v']},
           "post", "cckm/oci/add-vaults"),
    Action("cckm_oci_vault",
           {'op_type': 'create_external', 'vault_name': 'v', 'endpoint_url_hostname': 'h', 'client_application_id': 'a', 'issuer_id': 'i'},
           "post", "cckm/oci/create-external-vault"),
    Action("cckm_oci_vault",
           {'op_type': 'patch', 'vault_id': 'res-1', 'policy': 'p'},
           "patch", "cckm/oci/vaults/res-1"),
    Action("cckm_oci_vault",
           {'op_type': 'block', 'vault_id': 'res-1'},
           "post", "cckm/oci/vaults/res-1/block"),
    Action("cckm_oci_vault",
           {'op_type': 'unblock', 'vault_id': 'res-1'},
           "post", "cckm/oci/vaults/res-1/unblock"),
    Action("cckm_oci_vault",
           {'op_type': 'update_acls', 'vault_id': 'res-1', 'acls': []},
           "post", "cckm/oci/vaults/res-1/update-acls"),
    Action("cckm_oci_vault",
           {'op_type': 'delete', 'vault_id': 'res-1'},
           "delete", "cckm/oci/vaults/res-1"),
    Action("cckm_oci_issuer",
           {'op_type': 'create', 'name': 'n', 'jwks_uri_protected': False},
           "post", "cckm/oci/issuers"),
    Action("cckm_oci_issuer",
           {'op_type': 'patch', 'issuer_id': 'res-1', 'name': 'n2'},
           "patch", "cckm/oci/issuers/res-1"),
    Action("cckm_oci_issuer",
           {'op_type': 'delete', 'issuer_id': 'res-1'},
           "delete", "cckm/oci/issuers/res-1"),
    Action("cckm_oci_key",
           {'op_type': 'create', 'vault': 'v', 'name': 'n', 'algorithm': 'AES', 'length': 32, 'protection_mode': 'HSM', 'compartment_id': 'c'},
           "post", "cckm/oci/keys"),
    Action("cckm_oci_key",
           {'op_type': 'upload',
            'vault': 'v',
           ...
           "post", "cckm/oci/upload-key"),
    Action("cckm_oci_key",
           {'op_type': 'create_external', 'vault': 'v', 'name': 'n', 'source_key_identifier': 's', 'source_key_tier': 'local'},
           "post", "cckm/oci/create-external-key"),
    Action("cckm_oci_key",
           {'op_type': 'patch', 'key_id': 'res-1', 'display_name': 'd'},
           "patch", "cckm/oci/keys/res-1"),
    Action("cckm_oci_key",
           {'op_type': 'delete', 'key_id': 'res-1'},
           "delete", "cckm/oci/keys/res-1"),
    Action("cckm_oci_key",
           {'op_type': 'block', 'key_id': 'res-1'},
           "post", "cckm/oci/keys/res-1/block"),
    Action("cckm_oci_key",
           {'op_type': 'unblock', 'key_id': 'res-1'},
           "post", "cckm/oci/keys/res-1/unblock"),
    Action("cckm_oci_key",
           {'op_type': 'enable', 'key_id': 'res-1'},
           "post", "cckm/oci/keys/res-1/enable"),
    Action("cckm_oci_key",
           {'op_type': 'disable', 'key_id': 'res-1'},
           "post", "cckm/oci/keys/res-1/disable"),
    Action("cckm_oci_key",
           {'op_type': 'refresh', 'key_id': 'res-1'},
           "post", "cckm/oci/keys/res-1/refresh"),
    Action("cckm_oci_key",
           {'op_type': 'restore', 'key_id': 'res-1'},
           "post", "cckm/oci/keys/res-1/restore"),
    Action("cckm_oci_key",
           {'op_type': 'cancel_deletion', 'key_id': 'res-1'},
           "post", "cckm/oci/keys/res-1/cancel-deletion"),
    Action("cckm_oci_key",
           {'op_type': 'delete_backup', 'key_id': 'res-1'},
           "post", "cckm/oci/keys/res-1/delete-backup"),
    Action("cckm_oci_key",
           {'op_type': 'disable_auto_rotation', 'key_id': 'res-1'},
           "post", "cckm/oci/keys/res-1/disable-auto-rotation"),
    Action("cckm_oci_key",
           {'op_type': 'schedule_deletion', 'key_id': 'res-1', 'days': 30},
           "post", "cckm/oci/keys/res-1/schedule-deletion"),
    Action("cckm_oci_key",
           {'op_type': 'change_compartment', 'key_id': 'res-1', 'compartment_id': 'c'},
           "post", "cckm/oci/keys/res-1/change-compartment"),
    Action("cckm_oci_key",
           {'op_type': 'enable_auto_rotation', 'key_id': 'res-1', 'job_config_id': 'j', 'auto_rotate_key_source': 'native'},
           "post", "cckm/oci/keys/res-1/enable-auto-rotation"),
    Action("cckm_oci_key",
           {'op_type': 'create_version', 'key_id': 'res-1', 'is_native': True},
           "post", "cckm/oci/keys/res-1/versions"),
    Action("cckm_oci_key",
           {'op_type': 'schedule_version_deletion', 'key_id': 'res-1', 'version_id': 'ver-1', 'days': 30},
           "post", "cckm/oci/keys/res-1/versions/ver-1/schedule-deletion"),
    Action("cckm_oci_key",
           {'op_type': 'cancel_version_deletion', 'key_id': 'res-1', 'version_id': 'ver-1'},
           "post", "cckm/oci/keys/res-1/versions/ver-1/cancel-deletion"),
    Action("cckm_oci_report",
           {'op_type': 'create', 'name': 'n', 'report_type': 'key-report', 'oci_params': []},
           "post", "cckm/oci/reports"),
    Action("cckm_oci_report",
           {'op_type': 'delete', 'report_id': 'res-1'},
           "delete", "cckm/oci/reports/res-1"),
    Action("cckm_oci_synchronization_job",
           {'op_type': 'start', 'synchronize_all': True},
           "post", "cckm/oci/synchronization-jobs"),
    Action("cckm_oci_synchronization_job",
           {'op_type': 'cancel', 'job_id': 'res-1'},
           "post", "cckm/oci/synchronization-jobs/res-1/cancel"),
    Action("cckm_oci_tenancy_info",
           {'op_type': 'list'},
           "get", "cckm/oci/tenancy",
           writes=False),
    Action("cckm_oci_tenancy_info",
           {'op_type': 'get', 'tenancy_id': 'res-1'},
           "get", "cckm/oci/tenancy/res-1",
           writes=False),
    Action("cckm_oci_tenancy_info",
           {'op_type': 'regions', 'connection': 'c'},
           "post", "cckm/oci/get-subscribed-regions",
           writes=False),
    Action("cckm_oci_compartment_info",
           {'op_type': 'list'},
           "get", "cckm/oci/compartments",
           writes=False),
    Action("cckm_oci_compartment_info",
           {'op_type': 'get', 'compartment_id': 'res-1'},
           "get", "cckm/oci/compartments/res-1",
           writes=False),
    Action("cckm_oci_compartment_info",
           {'op_type': 'available', 'connection': 'c'},
           "post", "cckm/oci/get-compartments",
           writes=False),
    Action("cckm_oci_compartment_info",
           {'op_type': 'defined_tags', 'connection': 'c'},
           "post", "cckm/oci/get-defined-tags",
           writes=False),
    Action("cckm_oci_compartment_info",
           {'op_type': 'buckets', 'connection': 'c', 'compartment_id': 'res-1'},
           "post", "cckm/oci/storage/list-buckets",
           writes=False),
    Action("cckm_oci_vault_info",
           {'op_type': 'list'},
           "get", "cckm/oci/vaults",
           writes=False),
    Action("cckm_oci_vault_info",
           {'op_type': 'get', 'vault_id': 'res-1'},
           "get", "cckm/oci/vaults/res-1",
           writes=False),
    Action("cckm_oci_vault_info",
           {'op_type': 'available', 'connection': 'c', 'compartment_id': 'res-1', 'region': 'r'},
           "post", "cckm/oci/get-vaults",
           writes=False),
    Action("cckm_oci_issuer_info",
           {'op_type': 'list'},
           "get", "cckm/oci/issuers",
           writes=False),
    Action("cckm_oci_issuer_info",
           {'op_type': 'get', 'issuer_id': 'res-1'},
           "get", "cckm/oci/issuers/res-1",
           writes=False),
    Action("cckm_oci_key_info",
           {'op_type': 'list'},
           "get", "cckm/oci/keys",
           writes=False),
    Action("cckm_oci_key_info",
           {'op_type': 'get', 'key_id': 'res-1'},
           "get", "cckm/oci/keys/res-1",
           writes=False),
    Action("cckm_oci_key_info",
           {'op_type': 'list_versions', 'key_id': 'res-1'},
           "get", "cckm/oci/keys/res-1/versions",
           writes=False),
    Action("cckm_oci_key_info",
           {'op_type': 'get_version', 'key_id': 'res-1', 'version_id': 'ver-1'},
           "get", "cckm/oci/keys/res-1/versions/ver-1/",
           writes=False),
    Action("cckm_oci_report_info",
           {'op_type': 'list'},
           "get", "cckm/oci/reports",
           writes=False),
    Action("cckm_oci_report_info",
           {'op_type': 'get', 'report_id': 'res-1'},
           "get", "cckm/oci/reports/res-1",
           writes=False),
    Action("cckm_oci_report_info",
           {'op_type': 'contents', 'report_id': 'res-1'},
           "get", "cckm/oci/reports/res-1/contents",
           writes=False),
    Action("cckm_oci_report_info",
           {'op_type': 'download', 'report_id': 'res-1'},
           "get", "cckm/oci/reports/res-1/download",
           writes=False),
    Action("cckm_oci_synchronization_job_info",
           {'op_type': 'list'},
           "get", "cckm/oci/synchronization-jobs",
           writes=False),
    Action("cckm_oci_synchronization_job_info",
           {'op_type': 'get', 'job_id': 'res-1'},
           "get", "cckm/oci/synchronization-jobs/res-1",
           writes=False),
]
