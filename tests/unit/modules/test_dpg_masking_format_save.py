...
from ansible_collections.thalesgroup.ciphertrust.plugins.modules.dpg_masking_format_save import main

class TestDpgMaskingFormatSave:
    @patch("ansible_collections.thalesgroup.ciphertrust.plugins.modules.dpg_masking_format_save.ThalesCipherTrustModule")
    @patch("ansible_collections.thalesgroup.ciphertrust.plugins.modules.dpg_masking_format_save.idempotent_create")
    ...
    @patch("ansible_collections.thalesgroup.ciphertrust.plugins.modules.dpg_masking_format_save.ThalesCipherTrustModule")
    @patch("ansible_collections.thalesgroup.ciphertrust.plugins.modules.dpg_masking_format_save.idempotent_patch")
