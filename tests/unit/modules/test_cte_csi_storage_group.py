...
from ansible_collections.thalesgroup.ciphertrust.plugins.modules.cte_csi_storage_group import main

class TestCteCsiStorageGroup:
    @patch("ansible_collections.thalesgroup.ciphertrust.plugins.modules.cte_csi_storage_group.ThalesCipherTrustModule")
    @patch("ansible_collections.thalesgroup.ciphertrust.plugins.modules.cte_csi_storage_group.idempotent_create")
    ...
    @patch("ansible_collections.thalesgroup.ciphertrust.plugins.modules.cte_csi_storage_group.ThalesCipherTrustModule")
    @patch("ansible_collections.thalesgroup.ciphertrust.plugins.modules.cte_csi_storage_group.idempotent_patch")
