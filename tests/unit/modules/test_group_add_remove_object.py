...
from ansible_collections.thalesgroup.ciphertrust.plugins.modules.group_add_remove_object import main

class TestGroupAddRemoveObject:
    @patch("ansible_collections.thalesgroup.ciphertrust.plugins.modules.group_add_remove_object.ThalesCipherTrustModule")
