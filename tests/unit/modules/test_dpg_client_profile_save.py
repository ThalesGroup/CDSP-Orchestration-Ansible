...
from ansible_collections.thalesgroup.ciphertrust.plugins.modules.dpg_client_profile_save import main

class TestDpgClientProfileSave:
    @patch("ansible_collections.thalesgroup.ciphertrust.plugins.modules.dpg_client_profile_save.ThalesCipherTrustModule")
    @patch("ansible_collections.thalesgroup.ciphertrust.plugins.modules.dpg_client_profile_save.idempotent_create")
    ...
    @patch("ansible_collections.thalesgroup.ciphertrust.plugins.modules.dpg_client_profile_save.ThalesCipherTrustModule")
    @patch("ansible_collections.thalesgroup.ciphertrust.plugins.modules.dpg_client_profile_save.idempotent_patch")
