...
from ansible_collections.thalesgroup.ciphertrust.plugins.modules.license_create import main

class TestLicenseCreate:
    @patch("ansible_collections.thalesgroup.ciphertrust.plugins.modules.license_create.ThalesCipherTrustModule")
