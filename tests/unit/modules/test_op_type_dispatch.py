...
GENERIC_PARAMS = {
    ...
    # CCKM AWS
    "acls": [{"group": "cloud-team", "actions": ["keycreate"]}],
    "alias": "dispatch-test",
    "authentication_tag": "dGFn",
    "aws_param": {"alias": "dispatch-test"},
    "ciphertext": "Y2lwaGVy",
    "cloud_watch_params": [{"kms": "dispatch-test"}],
    "connection": "dispatch-test",
    ...
    "tags": [{"tag_key": "environment", "tag_value": "test"}],
    "template_id": "tpl-1",
    "xks_key_id": "xks-1",
...
MODULES = [
    "cckm_aws_account_info", "cckm_aws_bulkjob", "cckm_aws_bulkjob_info",
    "cckm_aws_custom_key_store", "cckm_aws_custom_key_store_info",
    "cckm_aws_key", "cckm_aws_key_info", "cckm_aws_kms", "cckm_aws_kms_info",
    "cckm_aws_policy_template", "cckm_aws_policy_template_info",
    "cckm_aws_report", "cckm_aws_report_info",
    "cckm_aws_synchronization_job", "cckm_aws_synchronization_job_info",
    "cckm_aws_xks_proxy",
