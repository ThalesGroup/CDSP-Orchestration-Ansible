...
from ansible_collections.thalesgroup.ciphertrust.plugins.modules.cte_client_group import main

class TestCteClientGroup:
    @patch("ansible_collections.thalesgroup.ciphertrust.plugins.modules.cte_client_group.ThalesCipherTrustModule")
    @patch("ansible_collections.thalesgroup.ciphertrust.plugins.modules.cte_client_group.idempotent_create")
    ...
    @patch("ansible_collections.thalesgroup.ciphertrust.plugins.modules.cte_client_group.ThalesCipherTrustModule")
    @patch("ansible_collections.thalesgroup.ciphertrust.plugins.modules.cte_client_group.idempotent_patch")
