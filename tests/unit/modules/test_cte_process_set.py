...
from ansible_collections.thalesgroup.ciphertrust.plugins.modules.cte_process_set import main

class TestCteProcessSet:
    @patch("ansible_collections.thalesgroup.ciphertrust.plugins.modules.cte_process_set.ThalesCipherTrustModule")
    @patch("ansible_collections.thalesgroup.ciphertrust.plugins.modules.cte_process_set.idempotent_create")
    ...
    @patch("ansible_collections.thalesgroup.ciphertrust.plugins.modules.cte_process_set.ThalesCipherTrustModule")
    @patch("ansible_collections.thalesgroup.ciphertrust.plugins.modules.cte_process_set.idempotent_patch")
