...
class TestCteResourceSet:
    @patch("ansible_collections.thalesgroup.ciphertrust.plugins.modules.cte_resource_set.ThalesCipherTrustModule")
    @patch("ansible_collections.thalesgroup.ciphertrust.plugins.modules.cte_resource_set.idempotent_create")
    ...
    @patch("ansible_collections.thalesgroup.ciphertrust.plugins.modules.cte_resource_set.ThalesCipherTrustModule")
    @patch("ansible_collections.thalesgroup.ciphertrust.plugins.modules.cte_resource_set.idempotent_patch")
