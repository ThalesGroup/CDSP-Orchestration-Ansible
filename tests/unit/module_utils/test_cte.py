...
class TestCTEPolicy:
    ...
    def test_update(self, MC):
        m = MC.return_value; m.patch.return_value = {}
    ...
    def test_add_rule(self, MC):
        m = MC.return_value; m.post.return_value = {}
    ...
    def test_delete_rule(self, MC):
        m = MC.return_value; m.delete.return_value = {}
...
class TestProcessSet:
    @patch(MODULE_PATH)
    def test_create(self, MC):
        m = MC.return_value; m.post.return_value = {"id": "ps1"}
...
class TestResourceSet:
    @patch(MODULE_PATH)
    def test_create(self, MC):
        m = MC.return_value; m.post.return_value = {"id": "rs1"}
...
class TestSignatureSet:
    @patch(MODULE_PATH)
    def test_create(self, MC):
        m = MC.return_value; m.post.return_value = {"id": "ss1"}
    ...
    def test_get_by_filter(self, MC):
        m = MC.return_value; m.get.return_value = {"resources": []}
...
class TestCTEUserSet:
    @patch(MODULE_PATH)
    def test_create(self, MC):
        m = MC.return_value; m.post.return_value = {"id": "us1"}
...
class TestCSIStorageGroup:
    @patch(MODULE_PATH)
    def test_create(self, MC):
        m = MC.return_value; m.post.return_value = {"id": "csi1"}
...
class TestClientGroup:
    @patch(MODULE_PATH)
    def test_create(self, MC):
        m = MC.return_value; m.post.return_value = {"id": "cg1"}
...
class TestCTEClient:
    ...
    def test_create_client(self, MC):
        m = MC.return_value; m.post.return_value = {"id": "cl1"}
