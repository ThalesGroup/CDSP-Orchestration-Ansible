...
DOCUMENTATION = """
---
module: cckm_azure_certificate_info
short_description: Read Azure Key Vault certificates known to CCKM
description:
    - Lists or reads the Azure Key Vault certificates CCKM manages.
    - Create, import or act on a certificate with
      M(thalesgroup.ciphertrust.cckm_azure_certificate).
version_added: "1.1.0"
author:
  - Anurag Jain (@anugram)
...
options:
    op_type:
      description:
        ...
        - C(list) returns a filtered collection; C(get) reads one certificate.
      choices: [list, get]
      default: list
      type: str
    certificate_id:
    ...
    cid:
      description:
        - Filter by Azure certificate identifier.
      type: str
    kid:
      description:
        - Filter by the identifier of the backing key.
      type: str
    sid:
      description:
        - Filter by the identifier of the backing secret.
      type: str
    version:
      description:
        - Filter by certificate version.
      type: str
    algorithm:
      description:
    ...
    enabled:
      description:
        - Filter by whether the certificate is enabled.
      type: bool
    backup:
      description:
    ...
    deleted_in_azure:
      description:
        - Filter by certificates deleted in Azure.
      type: bool
    gone:
      description:
        - Filter by certificates no longer present in Azure.
      type: bool
    managed:
      description:
        - Filter by Azure-managed certificates.
      type: bool
    ...
    job_config_id:
      ...
      type: str
    cert_material_origin:
      description:
        - Filter by where the certificate came from.
      type: str
    cert_source:
      description:
        - Filter by certificate source.
      type: str
    tags:
      description:
        - Filter by tag.
...
EXAMPLES = """
- name: "List the certificates in one vault"
  thalesgroup.ciphertrust.cckm_azure_certificate_info:
    localNode: "{{ cm_connection }}"
    op_type: list
    key_vault: production-vault

- name: "Read one certificate"
  thalesgroup.ciphertrust.cckm_azure_certificate_info:
    localNode: "{{ cm_connection }}"
    op_type: get
...
argument_spec = dict(
    ...
    cert_material_origin=dict(type="str"),
    cert_source=dict(type="str"),
...
_LIST_FILTERS = {
    ...
    "tags": "tags",
    "cert_material_origin": "cert_material_origin",
    "managed": "managed",
...
def main():
    ...
    with ciphertrust_operation(module):
        if op_type == "list":
            result["response"] = cckm_azure.certificate_list(
                node=node,
            ...
            result["response"] = cckm_azure.certificate_get(
                node=node,
