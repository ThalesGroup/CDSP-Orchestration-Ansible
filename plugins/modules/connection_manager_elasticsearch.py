...
DOCUMENTATION = '''
---
module: connection_manager_elasticsearch
short_description: Manage Elasticsearch log forwarder connections
description:
    ...
    elasticsearch_params:
        ...
        suboptions:
          ...
          insecure_tls_skip_verify:
            ...
            type: bool
          transport:
            description: Transport mode for sending data, supports "tls" and "tcp". "tls" requires either a trusted CA cert or insecure TLS skip verify to be set to true. Default is "tcp"
            type: str
