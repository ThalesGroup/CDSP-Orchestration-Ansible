...
DOCUMENTATION = '''
---
module: connection_manager_smb
short_description: Manage connections to file shares using the Server Message Block (SMB) protocol
description:
...
options:
    ...
    products:
        ...
        element: str
    password:
        description: Password for SMB share
        default: none
        type: str
    username:
        description: Username for accessing SMB share
        default: none
        type: str
    domain:
        description: Domain for SMB share
        default: none
        type: str
    host:
        description: Hostname or FQDN of SMB share
        default: none
        type: str
    port:
        description: Port where SMB service runs on host (usually 445)
        default: none
        type: str
'''
...
argument_spec = dict(
    ...
    domain=dict(type='str', options=['key', 'password']),
    host=dict(type='str'),
    port=dict(type='str'),
    name=dict(type='str'),
...
def setup_module_object():
    module = ThalesCipherTrustModule(
        ...
        required_if=(
            ...
            ['op_type', 'create', ['name', 'username', 'password']],
        ),
        mutually_exclusive=[],
